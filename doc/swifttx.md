...
This mechanism has been integrated into Bitcore-Node-Ultrachaint which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Ultrachaint-Project/insight-api-ultrachaint#web-socket-api](https://github.com/Ultrachaint-Project/insight-api-ultrachaint#web-socket-api) 
* API: [https://github.com/Ultrachaint-Project/insight-api-ultrachaint#swifttx-transactions](https://github.com/Ultrachaint-Project/insight-api-ultrachaint#swifttx-transactions) 
...
By default, the Ultrachaint Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ultrachaint Core daemon:
