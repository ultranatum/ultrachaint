...
In order to support loading of multiple wallets in ultrachaint-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ultrachaint.cpp.
...
Changes to ultrachaint.cpp
----------------------
ultrachaint.cpp is the entry point into ultrachaint-qt, and as such, will require some minor modifications to provide hooks for
