Contributing to Ultrachaint Core
============================

The Ultrachaint Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ultrachaint Core project, and is not to be
confused with overall Ultrachaint Network Protocol consensus changes.

Whether a pull request is merged into Ultrachaint Core rests with the project merge
...
Patches that change Ultrachaint consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ultrachaint consensus, it must have been
...
The project leader is the release manager for each Ultrachaint Core release.
