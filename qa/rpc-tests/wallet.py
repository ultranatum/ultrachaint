...
#   c) node1 mines 32 blocks, so now node 0 has 60001ultrex, node 1 has 4250ultrex, node2 has none.
#   d) node0 sends 601 ultrex to node2, in two transactions (301 ultrex, then 300 ultrex).
