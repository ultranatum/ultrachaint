...
#ifndef ULTRACHAINT_ZULTREXTRACKER_H
#define ULTRACHAINT_ZULTREXTRACKER_H
...
public:
    CzULTREXTracker(std::string strWalletFile);
    ~CzULTREXTracker();
...
#endif //ULTRACHAINT_ZULTREXTRACKER_H
