...
/** Utility functions used by the Ultrachaint Qt UI.
 */
namespace GUIUtil
{
...
// Render Ultrachaint addresses in monospace font
...
// Parse "ultrachaint:" URI into recipient object, return true on successful parsing
