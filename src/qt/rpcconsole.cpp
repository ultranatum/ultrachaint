                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzULTREXPathCustom = GetArg("-zultrexbackuppath", "");
    ...
    if(!strzULTREXPathCustom.empty()) {
        ui->wallet_customzultrexbackuppath->setText(QString::fromStdString(strzULTREXPathCustom));
        ui->wallet_customzultrexbackuppath_label->setVisible(true);
        ui->wallet_customzultrexbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzULTREXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Ultrachaint RPC console.") + "<br>" +
