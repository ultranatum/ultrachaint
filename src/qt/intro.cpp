...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ultrachaint Core"),
     ...
     * override -datadir in the ultrachaint.conf file in the default data directory
     * (to be consistent with ultrachaintd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
