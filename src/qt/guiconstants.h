...
/* Ultrachaint GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ultrachaint"
#define QAPP_ORG_DOMAIN "ultrachaint.org"
#define QAPP_APP_NAME_DEFAULT "Ultrachaint-Qt"
#define QAPP_APP_NAME_TESTNET "Ultrachaint-Qt-testnet"
