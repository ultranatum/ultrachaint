                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ultrachaint Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ultrachaint address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ultrachaint: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zULTREX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ultrachaint Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ultrachaint Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ultrachaint"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ultrachaint addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ultrachaint addresses"));
    ...
    openAction->setStatusTip(tr("Open a Ultrachaint: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ultrachaint Core help message to get a list with possible Ultrachaint command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ultrachaint Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ultrachaint network", "", count));
}
...
{
    QString strTitle = tr("Ultrachaint Core"); // default title
