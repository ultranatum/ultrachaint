...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("ULTREX Stake");
    case TransactionRecord::StakeZULTREX:
        return tr("zULTREX Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted ULTREX to zULTREX");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zULTREX");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received ULTREX from zULTREX");
    case TransactionRecord::ZerocoinSpend_Change_zUltrex:
        return tr("Minted Change as zULTREX from zULTREX Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zULTREX to ULTREX");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zUltrex:
        return tr("Anonymous (zULTREX Transaction)");
    case TransactionRecord::StakeZULTREX:
        return tr("Anonymous (zULTREX Stake)");
    case TransactionRecord::SendToSelf:
    default:
