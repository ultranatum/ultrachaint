...
public:
    ...
    void setZUltrexControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzULTREX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzULTREX_clicked();
    void on_pushButtonZUltrexControl_clicked();
