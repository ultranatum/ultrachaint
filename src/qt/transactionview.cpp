 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZULTREX));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    // ultrex typeWidget->addItem(tr("Received ULTREX from zULTREX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    // ultrex typeWidget->addItem(tr("Zerocoin Mint"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinMint));
    // ultrex typeWidget->addItem(tr("Zerocoin Spend"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend));
    // ultrex typeWidget->addItem(tr("Zerocoin Spend, Change in zULTREX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zUltrex));
    // ultrex typeWidget->addItem(tr("Zerocoin Spend to Self"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_FromMe));
