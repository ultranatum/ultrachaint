...
public:
    ...
    bool WriteZULTREXSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZULTREXSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZULTREXSeed_deprecated(uint256& seed);
    bool EraseZULTREXSeed();
    bool EraseZULTREXSeed_deprecated();

    bool WriteZULTREXCount(const uint32_t& nCount);
    bool ReadZULTREXCount(uint32_t& nCount);
