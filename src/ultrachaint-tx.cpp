...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ultrachaint Core ultrachaint-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ultrachaint-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ultrachaint transaction") + "\n" +
                               "  ultrachaint-tx [options] -create [commands]   " + _("Create hex-encoded ultrachaint transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ultrachaint transaction
