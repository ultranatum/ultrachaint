...
/**
 * Ultrachaint RPC command dispatcher.
 */
class CRPCTable
{
private:
...
// ultrex extern UniValue getzerocoinbalance(const UniValue& params, bool fHelp);
...
extern UniValue setzultrexseed(const UniValue& params, bool fHelp);
extern UniValue getzultrexseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzultrex(const UniValue& params, bool fHelp);
extern UniValue dzultrexstate(const UniValue& params, bool fHelp);
